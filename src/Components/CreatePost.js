                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="p-4 rounded shadow" style={{overflow:'hidden'}}>
                            <h5 class="text-md-left text-center">Post  :</h5>
                            ...
                            <form>
                                <div class="row mt-4">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group position-relative">
                                            <label>Doctor UID</label>
                                            
                                            <input onChange={this.handleChange} name="doctorid" id="doctorid" type="text" class="form-control pl-5" />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group position-relative">
                                            <label>Enter the disease </label>
